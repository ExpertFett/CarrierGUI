-- CarrierGUI Hook  (rebuild v1.3-beta18 — full 5-tab UX overhaul)
...
local function load()
    ...
    -- v1.3-beta18: register the drawn-scope widgets (solid fills, rings,
    ...
    local FULL_W, FULL_H = 540, 900   -- v1.3-beta18: bumped for radar overlays
    ...
    local function readShipState()
        -- v1.3-beta18: primary source is the mission query (carrier.q.ship);
    ...
    -- =====================================================================
    -- v1.3-beta18: MISSION QUERY — the hook pulls all live data itself via
...
return 'ERR|' .. tostring(resQ)
    ...
    -- Stack file format includes ALT/IAS/POINT/STATE.  v1.3-beta18 also
    ...
    local function readStackState()
        ...
        for line in content:gmatch('[^\r\n]+') do
            -- v1.3-beta18 format adds relE|relN (nm offsets from the stack
        ...
        -- v1.3-beta18: mapped onto the drawn gridlines — 15k → y=56, 0 → y=152.
        local allAir = {}
        ...
        -- Stack scope scatter — v1.3-beta18: TRUE positions.  The query
    ...
    -- v1.3-beta18: aircraft slots (acftPat1..8) get repositioned to the
    ...
    -- v1.3-beta18: HORIZONTAL racetrack — bottom leg y=220 (upwind, ship at
    ...
    local function readDeckState()
        ...
        -- v1.3-beta18: HORIZONTAL deck — BOW = right, PORT = top.
    ...
    local function probeBridge()
        ...
        if ok and tostring(result) == '1' then
            ...
            -- v1.3-beta18: radar/roster data comes from the mission query and
    ...
    local function createWindow()
        ...
        -- tab buttons (v1.3-beta18: 5 tabs)
        ...
        wireClick('btnCharlieBroadcast', function()
            ...
            fireFlag(201)
            -- v1.3-beta18: flip every HOLDing aircraft to CHARLIE'D in the
    ...
    logInfo('hook loaded (v1.3-beta18)')
end
